...
public class OppositionCard : HoolheyakBaseCard
{
    private bool _autoConsumed;

    public OppositionCard() : base(-2, CardType.Status, CardRarity.Token, TargetType.None, true)
    {
    }
    ...
    public async Task ApplyPhase(PlayerChoiceContext choiceContext)
    {
        ...
        await PowerCmd.Apply<OppositionPower>(choiceContext, Owner.Creature, 1, Owner.Creature, this);
