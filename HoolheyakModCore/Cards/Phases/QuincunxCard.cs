...
public class QuincunxCard : HoolheyakBaseCard
{
    private bool _autoConsumed;

    public QuincunxCard() : base(-2, CardType.Status, CardRarity.Token, TargetType.None, true)
    {
    }
    ...
    public async Task ApplyPhase(PlayerChoiceContext choiceContext)
    {
        ...
        await PowerCmd.Apply<QuincunxPower>(choiceContext, Owner.Creature, 1, Owner.Creature, this);
