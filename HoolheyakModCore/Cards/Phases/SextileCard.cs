...
public class SextileCard : HoolheyakBaseCard
{
    private bool _autoConsumed;

    public SextileCard() : base(-2, CardType.Status, CardRarity.Token, TargetType.None, true)
    {
    }
    ...
    public async Task ApplyPhase(PlayerChoiceContext choiceContext)
    {
        ...
        await PowerCmd.Apply<SextilePower>(choiceContext, Owner.Creature, 1, Owner.Creature, this);
