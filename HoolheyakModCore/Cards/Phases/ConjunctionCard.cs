...
public class ConjunctionCard : HoolheyakBaseCard
{
    private bool _autoConsumed;

    public ConjunctionCard() : base(-2, CardType.Status, CardRarity.Token, TargetType.None, true)
    {
    }
    ...
    public async Task ApplyPhase(PlayerChoiceContext choiceContext)
    {
        ...
        await PowerCmd.Apply<ConjunctionPower>(choiceContext, Owner.Creature, 1, Owner.Creature, this);
