...
public class TrineCard : HoolheyakBaseCard
{
    ...
    public TrineCard() : base(-2, CardType.Status, CardRarity.Token, TargetType.None, true)
    {
    }
    ...
    public async Task ApplyPhase(PlayerChoiceContext choiceContext)
    {
        ...
        await PowerCmd.Apply<TrinePower>(choiceContext, Owner.Creature, 1, Owner.Creature, this);
