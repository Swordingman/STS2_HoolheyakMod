...
public sealed class EnemyManifold : CustomMonsterModel
{
    ...
    public override NCreatureVisuals? CreateCustomVisuals() =>
        NodeFactory<NCreatureVisuals>.CreateFromScene("res://HoolheyakMod/scenes/EnemyManifold.tscn");
    ...
    {
        var attack = new MoveState("ATTACK", AttackMove, new SingleAttackIntent(10));
    ...
    private async Task AttackMove(IReadOnlyList<Creature> targets)
    {
        ...
        await DamageCmd.Attack(10).FromMonster(this).Targeting(targets[0])
